...
The active selection is a guideline stating "Implement workflow commands as a run step to communicate with the runner". This is in the context of GitHub Actions workflows.
